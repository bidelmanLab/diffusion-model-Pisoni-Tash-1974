...
subplot(2, 2, 1);
plot(1:5, percentPa_classic, '-o', 'LineWidth', 2, 'Color', '#0072BD', 'MarkerFaceColor', '#0072BD', 'MarkerSize', 6);
...
plot(1:5, meanRTs_classic * 1000, '-s', 'LineWidth', 2.5, 'Color', '#D95319', 'MarkerFaceColor', '#D95319', 'MarkerSize', 7);
...
subplot(2, 2, 3);
plot(1:5, percentPa_flat, '-o', 'LineWidth', 2, 'Color', '#4DBEEF', 'MarkerFaceColor', '#4DBEEF', 'MarkerSize', 6);
xlim([0.5, 5.5]); ylim([-5, 105]); %grid on;
set(gca, 'XTick', 1:5, 'XTickLabel', {'S1 (/ba/)', 'S2', 'S3', 'S4', 'S5 (/pa/)'});
...
plot(1:5, meanRTs_flat * 1000, '-s', 'LineWidth', 2.5, 'Color', '#7E2F8E', 'MarkerFaceColor', '#7E2F8E', 'MarkerSize', 7);
...
sgtitle('Diffusion model  Parameter Comparison: Classic vs. Flat RT Drift Diffusion Profiles', 'FontSize', 12, 'FontWeight', 'bold');
